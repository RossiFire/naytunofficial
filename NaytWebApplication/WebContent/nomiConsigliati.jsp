...
<%
	...
	Vector <String> nomic = (Vector)request.getAttribute("nomi_consigliati");
	
	out.println("<p class='errore'>" + frase + "</p>");
	for(int i=0; i<nomic.size();i++) {
		out.println("<p class='consigliati'>" + nomic.elementAt(i) + "</p>");
	}
            ...
            <div class="row">
                <div class="col-md-3 footer-brand animated fadeInLeft">
                    ...
                    <p>Questo sito nasce principalmente dalla passione per Nayt.
                         � stato creato anche per facilitare l'utenza a trovare frasi o informazioni su di lui e sulla sua carriera.
                         Inoltre il sito pu� essere un buon inizio per chi ha appena conosciuto Nayt.
                    </p>
                </div>
                ...
                <div class="col-md-3 footer-ns animated fadeInRight">
                    <h4>Informazioni</h4>
                    <p>Questo sito non ha scopo di lucro. Al suo interno non sono inserite pubblicit� e non ci sono
